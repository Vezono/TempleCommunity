...
class ToraController(Controller):
    ...
    def chat_rules_callback(context: Context):
        return ToraBasicItemView(
            ("🏡Доми - це такі об'єднання євреїв та гоїв у міні-фракції, або групки. Дім може створити будь-хто. "
    ...
    def chat_rules_callback(context: Context):
        return ToraBasicItemView(
            ("✡️Євреї - це зазвичай олдфаги чату. Ми любимо євреїв, вони прикольні. Слово єврей у нас навпаки "
